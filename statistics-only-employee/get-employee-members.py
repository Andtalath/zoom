...
conn.request("GET", "/v2/groups/"+groupId+"/members?page_number=1&page_size=300", headers=headers)
...
while page_number != page_count:
    ...
    conn.request("GET", "/v2/groups/"+groupId+"/members?page_number="+str(page_number)+"&page_size=300", headers=headers)
